...
// ==================== Group Management ====================
export const LoadGroupList = createAction('LoadGroupList')
...
export const SearchMessages = createAction('SearchMessages')
...
export const FetchCooccurringTags = createAction('FetchCooccurringTags')
export const LoadAllBulletinAddresses = createAction('LoadAllBulletinAddresses')
