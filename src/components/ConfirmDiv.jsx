        ...
        <div className="modal-content-wrapper">
          ...
          {ConfirmPopup && (
            <p className="mb-6 text-text-secondary dark:text-dark-text-secondary">
              {ConfirmPopup.Message || ConfirmPopup.Content || 'Are you sure?'}
            </p>
          )}
          <div className="flex justify-end gap-3">
            <button
              ref={cancelRef}
              onClick={() => dispatch(setConfirmPopup(null))}
              className="btn-md bg-surface-alt/80 dark:bg-dark-surface-alt/80 text-text-secondary dark:text-dark-text-secondary border border-primary/20 dark:border-primary/30 hover:bg-primary/10 dark:hover:bg-primary/20"
            >
              Cancel
            </button>
